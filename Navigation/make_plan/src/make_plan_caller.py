'''
the move_base node provides a service named /make_plan.
This service allows you to calculate a global plan without
 causing the robot to execute the path.
'''
#! /usr/bin/env python
...
msg.goal.pose.position.x = 1.5
msg.goal.pose.position.y = -2.2
